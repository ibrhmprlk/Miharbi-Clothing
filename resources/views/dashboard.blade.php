...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .about-card { background: white; border-radius: 32px; overflow: hidden; box-shadow: 0 20px 60px -15px rgba(0, 0, 0, 0.1); position: relative; }
        .about-image-wrapper { position: relative; overflow: hidden; }
        .about-image-wrapper::after { content: ''; position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.3) 0%, transparent 50%); opacity: 0; transition: opacity 0.4s ease; }
        .about-card:hover .about-image-wrapper::after { opacity: 1; }
        .about-badge { display: inline-flex; align-items: center; gap: 8px; padding: 8px 16px; background: #eef2ff; color: #4f46e5; border-radius: 100px; font-size: 12px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px; }
        .about-title { font-size: clamp(2rem, 5vw, 3.5rem); font-weight: 800; line-height: 1.1; color: #0f172a; margin-bottom: 24px; }
        .about-text { font-size: 1.125rem; line-height: 1.8; color: #475569; }

        /* CONTACT SECTION */
        .contact-section { background: #0f172a; position: relative; overflow: hidden; }
        .contact-section::before { content: ''; position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: radial-gradient(circle at 20% 50%, rgba(79, 70, 229, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 80%, rgba(99, 102, 241, 0.1) 0%, transparent 50%); pointer-events: none; }
        .contact-grid { display: grid; grid-template-columns: 1fr; gap: 32px; }
        @media (min-width: 1024px) { .contact-grid { grid-template-columns: 1fr 1.2fr; gap: 48px; } }
        .contact-info-card { background: rgba(255, 255, 255, 0.03); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 24px; padding: 24px; }
        @media (min-width: 640px) { .contact-info-card { padding: 32px; } }
        .contact-info-item { display: flex; align-items: center; gap: 16px; padding: 16px 0; border-bottom: 1px solid rgba(255, 255, 255, 0.1); }
        @media (min-width: 640px) { .contact-info-item { gap: 20px; padding: 20px 0; } }
        .contact-info-item:last-child { border-bottom: none; }
        .contact-info-icon { width: 48px; height: 48px; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); border-radius: 14px; display: flex; align-items: center; justify-content: center; color: white; font-size: 20px; flex-shrink: 0; }
        @media (min-width: 640px) { .contact-info-icon { width: 56px; height: 56px; border-radius: 16px; font-size: 24px; } }
        .contact-form-card { background: white; border-radius: 24px; padding: 24px; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); }
        @media (min-width: 640px) { .contact-form-card { border-radius: 32px; padding: 32px; } }
        @media (min-width: 768px) { .contact-form-card { padding: 48px; } }
        .contact-input-modern { width: 100%; padding: 14px 18px; background: #f8fafc; border: 2px solid #e2e8f0; border-radius: 14px; font-size: 15px; font-weight: 500; color: #0f172a; transition: all 0.3s ease; }
        @media (min-width: 640px) { .contact-input-modern { padding: 16px 20px; border-radius: 16px; } }
        .contact-input-modern:focus { background: white; border-color: #4f46e5; box-shadow: 0 0 0 4px rgba(79, 70, 229, 0.1); outline: none; }
        .contact-input-modern::placeholder { color: #94a3b8; }
        .contact-submit-btn { width: 100%; padding: 16px 24px; background: linear-gradient(135deg, #4f46e5 0%, #7c3aed 100%); color: white; border: none; border-radius: 14px; font-size: 15px; font-weight: 700; cursor: pointer; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; gap: 10px; position: relative; overflow: hidden; }
        @media (min-width: 640px) { .contact-submit-btn { padding: 18px 32px; border-radius: 16px; font-size: 16px; gap: 12px; } }
        .contact-submit-btn::before { content: ''; position: absolute; top: 0; left: -100%; width: 100%; height: 100%; background: linear-gradient(90deg, transparent, rgba(255,255,255,0.2), transparent); transition: left 0.5s ease; }
        .contact-submit-btn:hover::before { left: 100%; }
        .contact-submit-btn:hover { transform: translateY(-2px); box-shadow: 0 12px 30px rgba(79, 70, 229, 0.4); }
        .contact-submit-btn:disabled { opacity: 0.7; cursor: not-allowed; transform: none; }
        .social-link-modern { width: 48px; height: 48px; background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 14px; display: flex; align-items: center; justify-content: center; color: white; font-size: 18px; transition: all 0.3s ease; text-decoration: none; }
        @media (min-width: 640px) { .social-link-modern { width: 52px; height: 52px; border-radius: 16px; font-size: 20px; } }
        .social-link-modern:hover { background: #4f46e5; border-color: #4f46e5; transform: translateY(-4px); box-shadow: 0 12px 24px rgba(79, 70, 229, 0.3); }
        ...
        .like-badge { display: inline-flex; align-items: center; gap: 4px; padding: 4px 8px; background: #fce7f3; color: #be185d; border-radius: 20px; font-size: 11px; font-weight: 700; }
        ...
        .review-action-btn { display: flex; align-items: center; gap: 4px; padding: 4px 8px; border-radius: 6px; font-size: 12px; font-weight: 600; cursor: pointer; transition: all 0.2s; border: none; background: transparent; }
        .review-action-btn.like { color: #64748b; }
        .review-action-btn.like:hover { background: #fce7f3; color: #be185d; }
        .review-action-btn.like.active { background: #fce7f3; color: #be185d; }
        .review-action-btn.reply { color: #64748b; }
        .review-action-btn.reply:hover { background: #eef2ff; color: #4f46e5; }
...
<header class="admin-nav shadow-sm" x-data="{
    ...
    <div class="max-w-7xl mx-auto px-4">
        <div class="flex items-center justify-between h-20">
            ...
            <nav class="hidden md:flex items-center gap-2">
                <button @click="scrollToSection('products')"
                    :class="activeSection === 'products' ? 'nav-item ' : 'nav-item'"
                    class="bg-transparent border-0">
                    <i class="bi bi-grid-1x2"></i>Dashboard
                </button>
                <button @click="scrollToSection('about')"
                    :class="activeSection === 'about' ? 'nav-item ' : 'nav-item'"
                    class="bg-transparent border-0">
                    <i class="bi bi-info-circle"></i>About Us
                </button>
                <button @click="scrollToSection('contact')"
                    :class="activeSection === 'contact' ? 'nav-item ' : 'nav-item'"
                    class="bg-transparent border-0">
        ...
        <nav x-show="mobileMenu" x-cloak @click.away="mobileMenu = false"
            ...
            <button @click="scrollToSection('products'); mobileMenu = false"
                :class="activeSection === 'products' ? 'nav-item  ' : 'nav-item mt-2'"
                class="w-full text-left bg-transparent border-0">
                <i class="bi bi-grid-1x2"></i>Dashboard
            </button>
            <button @click="scrollToSection('about'); mobileMenu = false"
                :class="activeSection === 'about' ? 'nav-item ' : 'nav-item'"
                class="w-full text-left bg-transparent border-0">
                <i class="bi bi-info-circle"></i>About Us
            </button>
            <button @click="scrollToSection('contact'); mobileMenu = false"
                :class="activeSection === 'contact' ? 'nav-item ' : 'nav-item'"
                class="w-full text-left bg-transparent border-0">
                <i class="bi bi-envelope"></i>Contact
            </button>
...
<div id="products-section" class="max-w-7xl mx-auto px-4 py-8">
        ...
        <div class="search-container group flex-1 !mb-0">
            ...
            <form action="{{ route('dashboard') }}" method="GET" id="searchForm">
                ...
                @if(request('q') || request('cat') || request('size') || request('min') || request('max') || request('brand') || request('collection'))
                    <button type="button" onclick="window.location.href='{{ route('dashboard') }}'" class="search-clear-btn">
                        <i class="bi bi-x-lg"></i>
                        <span>Reset</span>
                    </button>
                @endif
    ...
    <div x-show="showFilters" 
        ...
        <div @click.away="showFilters = false" 
            ...
            <form action="{{ route('dashboard') }}" method="GET" class="space-y-8">
    ...
    @if($urunler->isEmpty() && request()->anyFilled(['q', 'cat', 'brand', 'collection', 'size', 'min', 'max']))
        <div class="flex flex-col items-center justify-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
            ...
            <button onclick="window.location.href='{{ route('dashboard') }}'" class="mt-6 px-6 py-2 bg-indigo-600 text-white font-bold rounded-xl">Clear Filters</button>
        </div>
                    ...
                    <div class="product-card shadow-sm" id="p-card-{{ $uniqueId }}"
                        ...
                        <div class="carousel-container group/main relative">
                            ...
                            <div class="absolute top-2 left-2 z-20" x-show="reviewCount > 0">
                                <div class="review-badge">
                                    ...
                                    <span x-text="avgRating.toFixed(1)"></span>
                                    <span x-text="'(' + reviewCount + ')'" class="opacity-75"></span>
                                </div>
                            </div>
                            ...
                            <div class="image-scroll-container" id="scroll-{{ $uniqueId }}">
                                ...
                                <div class="scroll-slide"
                                    data-variant-id="{{ $img->variant_id ?? $firstVariantId }}"
                        ...
                        <div class="p-4 flex flex-col flex-1 space-y-3 justify-between">
                            ...
                            <div class="mt-4 flex items-end justify-between border-t pt-4">
                                ...
                                <button @click="openQuickView({{ json_encode($item) }}, variantId)"
...
<section id="about-section" class="about-section py-24 px-4">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
            <span class="about-badge mb-6"><i class="bi bi-stars"></i> About Us</span>
            <h2 class="text-4xl md:text-6xl font-black text-slate-900 tracking-tight mt-6">Crafting <span class="text-indigo-600">Excellence</span></h2>
            <p class="text-slate-500 text-lg max-w-2xl mx-auto mt-6 font-medium">Discover the story behind Miharbi Clothing and our commitment to quality.</p>
        </div>
        <div class="about-card">
            <div class="grid lg:grid-cols-2 gap-0">
                <div class="about-image-wrapper min-h-[400px] lg:min-h-[600px] bg-slate-100">
                    ...
                    @else
                        <div class="h-full flex flex-col items-center justify-center text-slate-400 gap-4 py-20">
                            <div class="w-24 h-24 bg-slate-200 rounded-full flex items-center justify-center"><i class="bi bi-image text-4xl"></i></div>
                ...
                <div class="p-8 md:p-12 lg:p-16 flex flex-col justify-center">
                    <span class="about-badge mb-6"><i class="bi bi-info-circle"></i> ABOUT US</span>
                    <h3 class="about-title">{{ $about->title ?? 'Miharbi Clothing' }}</h3>
                    <div class="space-y-6 about-text">
                        <p class="text-xl font-semibold text-slate-800 leading-relaxed">{{ $about->description ?? 'Premium quality clothing brand dedicated to style and comfort.' }}</p>
                        @if(isset($about) && $about->second_paragraph) <p>{{ $about->second_paragraph }}</p> @endif
                        @if(isset($about) && $about->last_paragraph) <p>{{ $about->last_paragraph }}</p> @endif
                    </div>
                    ...
                    <div class="mt-10 pt-8 border-t border-slate-100 grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="w-11 h-11 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600 shrink-0"><i class="bi bi-telephone-fill text-lg"></i></div>
                            <div><p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Phone</p><p class="text-base font-bold text-slate-900 leading-tight">{{ $about->phone }}</p></div>
                        </div>
                        @endif
                        @if($about->email)
                        <div class="flex items-center gap-4">
                            <div class="w-11 h-11 bg-indigo-50 rounded-xl flex items-center justify-center text-indigo-600 shrink-0"><i class="bi bi-envelope-fill text-lg"></i></div>
                            <div><p class="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none mb-1">Email</p><p class="text-base font-bold text-slate-900 leading-tight">{{ $about->email }}</p></div>
                        </div>
                        @endif
                    </div>
                    @endif
...
<section id="contact-section" class="contact-section py-16 sm:py-24 px-4">
    <div class="max-w-7xl mx-auto relative">
        <div class="text-center mb-12 sm:mb-16 px-2">
            <span class="inline-flex items-center gap-2 px-4 py-2 bg-white/10 text-white rounded-full text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-sm border border-white/10"><i class="bi bi-chat-dots"></i> Get In Touch</span>
            <h2 class="text-3xl sm:text-4xl md:text-6xl font-black text-white tracking-tight">Let's <span class="text-indigo-400">Connect</span></h2>
            <p class="text-slate-400 text-base sm:text-lg max-w-2xl mx-auto mt-4 sm:mt-6 font-medium px-4">Have a question or need assistance? We're here to help you with anything you need.</p>
        </div>
            ...
            <div class="space-y-4 sm:space-y-6">
                <div class="contact-info-card">
                    ...
                    <div class="contact-info-item">
                        ...
                        <div class="min-w-0"><p class="text-slate-400 text-xs sm:text-sm mb-1">Email</p><a href="mailto:{{ $about->email }}" class="text-white font-bold text-base sm:text-lg hover:text-indigo-400 transition break-all">{{ $about->email }}</a></div>
                    </div>
                    @endif
                    @if(isset($about) && $about->phone)
                    <div class="contact-info-item">
                        <div class="contact-info-icon"><i class="bi bi-telephone-fill"></i></div>
                        <div><p class="text-slate-400 text-xs sm:text-sm mb-1">Phone</p><a href="tel:{{ $about->phone }}" class="text-white font-bold text-base sm:text-lg hover:text-indigo-400 transition">{{ $about->phone }}</a></div>
                    </div>
                    @endif
                </div>
                ...
                <div class="flex gap-3 sm:gap-4 justify-center sm:justify-start">
                    @if(!empty($about->instagram_url)) <a href="{{ $about->instagram_url }}" target="_blank" class="social-link-modern"><i class="bi bi-instagram"></i></a> @endif
                    @if(!empty($about->twitter_url)) <a href="{{ $about->twitter_url }}" target="_blank" class="social-link-modern"><i class="bi bi-twitter-x"></i></a> @endif
                    @if(!empty($about->linkedin_url)) <a href="{{ $about->linkedin_url }}" target="_blank" class="social-link-modern"><i class="bi bi-linkedin"></i></a> @endif
                    @if(!empty($about->github_url)) <a href="{{ $about->github_url }}" target="_blank" class="social-link-modern"><i class="bi bi-github"></i></a> @endif
                </div>
                @endif
            </div>
...
<template x-if="quickView">
    <div class="quickview-overlay" x-cloak @click.self="quickView = false">
        <div class="bg-white w-full max-w-6xl max-h-[90vh] rounded-[40px] shadow-2xl overflow-hidden flex flex-col lg:flex-row relative"
             x-data="quickViewData()"
             x-init="initQuickView()">
                    ...
                    <div class="flex items-center gap-2">
                        <div class="star-rating">
                            <template x-for="i in 5" :key="i">
                                <i class="bi" :class="i <= Math.round(modalReviews.avg) ? 'bi-star-fill' : 'bi-star'"></i>
                            </template>
                        </div>
...
function appData() {
    return {
        ...
        debouncedFavoriteCheck: debounce(function(variantId) {
            ...
            .catch(e => console.error('Favori kontrol hatası:', e));
        }, 300),
            ...
            window.addEventListener('scroll', () => {
                ...
                for (const section of sections) {
                    ...
                    if (el) {
                        ...
                        if (scrollPos >= top && scrollPos < top + height) { this.activeSection = section; break; }
                    }
                }
            });
        },
...
function productCard(variantId, initialFavorite, avgRating, reviewCount) {
    return {
        variantId: variantId,
        ...
        debouncedToggle: debounce(function() {
            fetch(`/favorites/toggle/${this.variantId}`, { method: 'POST', headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content, 'Accept': 'application/json', 'Content-Type': 'application/json' } })
            .then(r => r.json())
            .then(data => {
            ...
            .catch(e => { console.error('Favori hatası:', e); this.isFavorite = !this.isFavorite; })
        ...
        handleFavoriteUpdate(detail) {
            if (detail.variantId === this.variantId) this.isFavorite = detail.isFavorite;
        }
    };
}
...
function quickViewData() {
    return {
        ...
        toggleModalFavoriteDebounced() {
            ...
            clearTimeout(this.favoriteDebounceTimer);
            this.favoriteDebounceTimer = setTimeout(() => {
                fetch(`/favorites/toggle/${this.activeVariant.id}`, { method: 'POST', headers: { 'X-CSRF-TOKEN': document.querySelector('meta[name=csrf-token]').content, 'Accept': 'application/json', 'Content-Type': 'application/json' } })
                .then(r => r.json())
                .then(data => {
                    const isNowFavorite = (data.status === 'added');
    ...
    return {
        ...
        async submit() {
            ...
            if (!this.form.name || !this.form.email || !this.form.message) {
                window.dispatchEvent(new CustomEvent('toast', { detail: { type: 'error', title: 'Error!', message: 'Please fill in all required fields.' } }));
                return;
            }
            this.loading = true;
            try {
